...
export const Navbar = () => {
    ...
    return (
      <nav
        ...
        className="top-0 md:top-6 right-0 md:right-6 left-0 md:left-6 z-10 fixed border-[1px] border-white/10 bg-gradient-to-br from-white/20 to-white/5 backdrop-blur mx-auto md:rounded-2xl max-w-6xl overflow-hidden glass-nav"
      >
  ...
  const Buttons = ({
    ...
    <div className="flex items-center gap-4">
      ...
      <button className="relative bg-gradient-to-br from-40% from-indigo-600 to-indigo-400 px-4 py-2 rounded-lg font-medium text-white transition-transform overflow-hidden scale-100 hover:scale-105 active:scale-95">
        Try free
      </button>
